...
/**
 * Defines a national product
 */
public class NationalProduct extends Product{
	@Serial
	private static final long serialVersionUID=-3900032400431003025L;
	/**
	...
	/**
	 * Constructs a new national trip
	 ...
	 */
	public NationalProduct(String designation,int duration,float VIPdiscount,float enterprisePrice,float comission,String departurePlace,String arrivalPlace){
